  ...
  return (
    <div className="mt-10 grid gap-6 md:grid-cols-2">
      <motion.div
        ...
        className="rounded-2xl bg-white/70 p-6 shadow-lg shadow-blue-200 backdrop-blur-md dark:bg-gray-800/70 dark:shadow-blue-800"
      >
        <h3 className="mb-4 text-xl font-bold text-gray-900 dark:text-gray-100">会社情報</h3>
      ...
      <motion.div
        ...
        className="rounded-2xl bg-white/70 p-6 shadow-lg shadow-blue-200 backdrop-blur-md dark:bg-gray-800/70 dark:shadow-blue-800"
      >
        <h3 className="mb-4 text-xl font-bold text-gray-900 dark:text-gray-100">ミッション</h3>
