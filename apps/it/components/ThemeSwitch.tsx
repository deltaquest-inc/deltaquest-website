...
const Sun = () => (
  <svg
    ...
    viewBox="0 0 20 20"
    fill="currentColor"
    className="group:hover:text-gray-100 h-6 w-6 cursor-pointer"
  >
    <path
      fillRule="evenodd"
  ...
  return (
    <div className="flex items-center">
      <Menu as="div" className="relative inline-block text-left">
        <div className="hover:text-blue-600 dark:hover:text-blue-400 flex items-center justify-center cursor-pointer">
